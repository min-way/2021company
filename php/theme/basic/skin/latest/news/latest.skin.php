...
?>
    ...
    <h2 class="newsTit"><a href="<?php echo get_pretty_url($bo_table); ?>"><?php echo $bo_subject ?></a></h2>
    <!-- <a href="<?php echo get_pretty_url($bo_table); ?>" class="more">more</a> -->

    <ul class="newsList clearfix">
      <li class="more"><a href="<?php echo get_pretty_url($bo_table); ?>">more</a></li>
